...
setuptools.setup(
    ...
    install_requires=['numpy', 'scipy', 'matplotlib', 'ipython', 'jupyter', 'pandas', 'sympy', 'nose', 'PyYaml',
                      ...
                      'scikit-image', 'open3d', 'pyrealsense2', 'pathlib', 'psutil', 'jsonschema==2.6.0',
                      'qtconsole==4.7.7', 'gitpython', 'urdfpy',
                      'hello-robot-stretch-body-tools','hello-robot-stretch-factory']
)
